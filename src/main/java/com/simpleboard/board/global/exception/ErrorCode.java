...
public enum ErrorCode {
  ...
  BOARD_NO_DELETE_PERMISSION(
      HttpStatus.BAD_REQUEST, "400_BOARD_NO_DELETE_PERMISSION", "Board에 대한 삭제 권한이 없습니다."),
  ...
  MEMBER_NOT_FOUND(HttpStatus.NOT_FOUND, "404_MEMBER_NOT_FOUND", "회원 정보를 찾을 수 없습니다."),

 ...
 *
 * <p>WebClient의 onStatus()에서 HTTP 4xx/5xx 응답을 처리하고, 커스텀 예외로 변환해주는 공통 유틸 클래스입니다.
 *
 * <p>ClientResponse로부터 상태 코드와 응답 본문을 추출하여, 적절한 예외 로그를 기록하고 RuntimeException 하위 커스텀 예외를 발생시킵니다.
 */

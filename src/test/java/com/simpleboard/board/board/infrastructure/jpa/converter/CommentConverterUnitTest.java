...
class CommentConverterUnitTest {
    ...
    void toJpaEntity_unknown_throws() {
        ...
        class UnknownComment extends Comment {
            public UnknownComment(CommentCreateParams p) { super(p); }
            @Override protected void checkPermission(com.simpleboard.board.board.domain.common.vo.Visitor v,
                                                     com.simpleboard.board.board.domain.comment.dto.CommentDeleteParams p) {}
        }
        CommentCreateParams params = CommentCreateParams.builder()
                .postId(1L).content("x").commentType(CommentType.GUEST).nickname("n").password("p").build();
    ...
    void toDomainEntity_guest_mapping() {
        ...
        LocalDateTime updated = LocalDateTime.now();
        GuestCommentEntity entity = GuestCommentEntity.builder()
                .id(777L)
                .parentId(55L)
                .postId(44L)
    ...
    void toDomainEntity_member_mapping() {
        ...
        MemberCommentEntity entity = MemberCommentEntity.builder()
                .id(888L)
                .parentId(null)
                .postId(99L)
    ...
    void roundTrip_guest() {
        // given
        CommentCreateParams params = CommentCreateParams.builder()
                .postId(10L).parentCommentId(9L).content("rr guest")
                .commentType(CommentType.GUEST).nickname("gn").password("pp").build();
        Comment guest = Comment.write(params);

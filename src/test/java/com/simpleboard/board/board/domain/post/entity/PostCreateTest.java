...
class PostCreateTest {
  ...
  void guestPost_Type_Test() {
    ...
    CreateParams params = CreateParamsBuilder.builder(guestVisitor).build();
  ...
  void memberPost_Type_Test() {
    ...
    CreateParams params = CreateParamsBuilder.builder(memberVisitor).build();
  ...
  void hashTag_Create_Test() {
    ...
    CreateParams params =
        CreateParamsBuilder.builder(visitor).hashTags("tag1 tag2,tag3#tag4 # # tag5").build();

...
class CommentFormCommandConverterTest {
  ...
  void toCommentCreateCommand_member() {
    ...
    Visitor visitor =
        Visitor.builder().type(VisitorType.MEMBER).memberId(1L).vId("vid-xxx").build();
  ...
  void toCommentCreateCommand_guest() {
    ...
    Visitor visitor = Visitor.builder().type(VisitorType.GUEST).vId("vid-guest").build();
  ...
  void toCommentCreateCommand_unsupportedVisitor() {
    // given
    CommentCreateForm form = new CommentCreateForm(1L, 2L, "x", null, null);
    Visitor visitor =
        Visitor.builder()
  ...
  void toCommentDeleteCommand_member() {
    ...
    Visitor visitor = Visitor.builder().type(VisitorType.MEMBER).memberId(1L).build();
  ...
  void toCommentDeleteCommand_guest() {
    ...
    Visitor visitor = Visitor.builder().type(VisitorType.GUEST).vId("vid-1").build();
  ...
  void toCommentDeleteCommand_unsupportedVisitor() {
    ...
    Visitor visitor = Visitor.builder().type(VisitorType.MANAGER).memberId(77L).build();
